          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="ten_san_pham" value="<?= $sanPham['ten_san_pham'] ?>"   placeholder="tên sản phẩm">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="gia_san_pham" value="<?= $sanPham['gia_san_pham'] ?>"   placeholder="giá sản phẩm">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="gia_khuyen_mai" value="<?= $sanPham['gia_khuyen_mai'] ?>"  placeholder="giá khuyến mãi">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="so_luong" value="<?= $sanPham['so_luong'] ?>" placeholder="số lượng">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="luot_xem" value="<?= $sanPham['luot_xem'] ?>" placeholder="lượt xem">
