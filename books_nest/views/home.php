						...
						<div class="slider-item">
							<div class="banner-content">
								...
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eu feugiat amet, libero
									...
									urna, a eu.</p>
								<div class="btn-wrap">
									<a href="index.html#" class="btn btn-outline-accent btn-accent-arrow">Read More<i
		...
		<div class="container">
			<div class="row">
				<div class="inner-content">
					<div class="logo-wrap">
						<div class="grid">
							<a href="index.html#"><img src="assets/images/client-image1.png" alt="client"></a>
							<a href="index.html#"><img src="assets/images/client-image2.png" alt="client"></a>
							<a href="index.html#"><img src="assets/images/client-image3.png" alt="client"></a>
							<a href="index.html#"><img src="assets/images/client-image4.png" alt="client"></a>
							<a href="index.html#"><img src="assets/images/client-image5.png" alt="client"></a>
						</div>
					</div><!--image-holder-->
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="btn-wrap align-right">
						<a href="index.html#" class="btn-accent-arrow">View all products <i
								class="icon icon-ns-arrow-right"></i></a>
					</div>
						...
						<div class="col-md-6">
							<div class="product-entry">
								...
								<div class="products-content">
									...
									<div class="item-price">$ 45.00</div>
									<div class="btn-wrap">
										<a href="index.html#" class="btn-accent-arrow">shop it now <i
												class="icon icon-ns-arrow-right"></i></a>
									</div>
								</div>
				...
				<div class="col-md-12">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<article class="column" data-aos="fade-up">
								...
								<figure>
									<a href="index.html#" class="image-hvr-effect">
								...
								<div class="post-item">
									...
									<h3><a href="index.html#">Reading books always makes the moments happy</a></h3>
									...
									<div class="links-element">
										...
										<div class="social-links">
											<ul>
												...
												<li>
													<a href="index.html#"><i class="icon icon-behance-square"></i></a>
												</li>
											</ul>
										</div>
									</div><!--links-element-->
					...
					<div class="row">
						...
						<div class="btn-wrap align-center">
							<a href="index.html#" class="btn btn-outline-accent btn-accent-arrow" tabindex="0">Read All Articles<i
									class="icon icon-ns-arrow-right"></i></a>
						</div>
					</div>
